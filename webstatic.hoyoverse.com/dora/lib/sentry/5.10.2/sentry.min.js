/*! @sentry/browser 5.10.2 (b12397a8) | ./github.com/getsentry/sentry-javascript */
var Sentry = function(n) {
    ...
    function(n) {
        n.Ok = "ok",
        n.DealineExceeded = "deadline_exceeded",
    ...
    var k = {};
    function S() {
        return j() ? global : "undefined" != typeof window ? window : "undefined" != typeof self ? self : k
    }
    function _() {
        var n = S()
    ...
    function I(n) {
        try {
            for (var t = n, r = [], e = 0, i = 0, o = " > ".length, u = void 0; t && e++ < 5 && !("html" === (u = C(t)) || e > 1 && i + r.length * o + u.length >= 80); )
                r.push(u),
                i += u.length,
                t = t.parentNode;
    ...
    function U(n, t) {
        ...
        if (!isNaN(r))
            return 1e3 * r;
        var e = Date.parse("" + t);
        return isNaN(e) ? A : e - n
    }
    var q = "<anonymous>";
    function L(n) {
        try {
            return n && "function" == typeof n && n.name || q
        } catch (n) {
            return q
        }
    }
      ...
      , F = function() {
        ...
        n.prototype.error = function() {
            for (var n = [], t = 0; t < arguments.length; t++)
                n[t] = arguments[t];
            this.t && D(function() {
                H.console.error(P + "[Error]: " + n.join(" "))
            })
        }
        ,
        n
    ...
    var W, X = H.__SENTRY__.logger || (H.__SENTRY__.logger = new F), B = function() {
        function n() {
    ...
    function V(n) {
        ...
        if (w(n)) {
            ...
            o.type = i.type;
            try {
                o.target = g(i.target) ? I(i.target) : Object.prototype.toString.call(i.target)
            } catch (n) {
                o.target = "<unknown>"
            }
            try {
                o.currentTarget = g(i.currentTarget) ? I(i.currentTarget) : Object.prototype.toString.call(i.currentTarget)
            } catch (n) {
    ...
    function Q(n, t, r) {
        ...
        void 0 === r && (r = 102400);
        var e = nn(n, t);
        return K(e) > r ? Q(n, t - 1, r) : e
    }
    function Y(n, t) {
        return "domain" === t && n && "object" == typeof n && n.u ? "[Domain]" : "domainEmitter" === t ? "[DomainEmitter]" : "undefined" != typeof global && n === global ? "[Global]" : "undefined" != typeof window && n === window ? "[Window]" : "undefined" != typeof document && n === document ? "[Document]" : b(r = n) && "nativeEvent"in r && "preventDefault"in r && "stopPropagation"in r ? "[SyntheticEvent]" : "number" == typeof n && n != n ? "[NaN]" : void 0 === n ? "[undefined]" : "function" == typeof n ? "[Function: " + L(n) + "]" : n;
        var r
    }
    function Z(n, t, r, e) {
        if (void 0 === r && (r = 1 / 0),
        ...
        if (e.memoize(t))
            return "[Circular ~]";
        for (var c in o)
            Object.prototype.hasOwnProperty.call(o, c) && (u[c] = Z(c, o[c], r - 1, e));
    ...
    var rn = function() {
        function n(n) {
            ...
            ,
            this.l = function(n, r) {
                t.s === W.PENDING && (E(r) ? r.then(t.v, t.p) : (t.s = n,
                t.m = r,
                t.g()))
            }
            ,
            ...
            ,
            this.g = function() {
                t.s !== W.PENDING && (t.s === W.REJECTED ? t.h.forEach(function(n) {
      ...
      , en = function() {
        ...
        n.prototype.add = function(n) {
            var t = this;
            return this.isReady() ? (-1 === this.S.indexOf(n) && this.S.push(n),
            n.then(function() {
                return t.remove(n)
            }).then(null, function() {
                return t.remove(n).then(null, function() {})
            }),
            n) : rn.reject(new v("Not adding Promise due to buffer limit reached."))
        }
        ,
        ...
        n.prototype.drain = function(n) {
            var t = this;
            return new rn(function(r) {
                var e = setTimeout(function() {
                    n && n > 0 && r(!1)
                }, n);
                rn.all(t.S).then(function() {
                    clearTimeout(e),
                    r(!0)
                }).then(null, function() {
                    r(!0)
        ...
        if (!hn[n])
            ...
            case "console":
                !function() {
                    if (!("console"in sn))
                        return;
                    ["debug", "info", "warn", "error", "log", "assert"].forEach(function(n) {
                        n in sn.console && z(sn.console, n, function(t) {
                            return function() {
                                ...
                                t && Function.prototype.apply.call(t, sn.console, r)
                            }
                        })
                    })
                }();
            ...
            case "dom":
                !function() {
                    if (!("document"in sn))
                        return;
                    sn.document.addEventListener("click", En("click", dn.bind(null, "dom")), !1),
                    sn.document.addEventListener("keypress", xn(dn.bind(null, "dom")), !1),
                    ["EventTarget", "Node"].forEach(function(n) {
                        var t = sn[n] && sn[n].prototype;
                        t && t.hasOwnProperty && t.hasOwnProperty("addEventListener") && (z(t, "addEventListener", function(n) {
                            return function(t, r, e) {
                                return r && r.handleEvent ? ("click" === t && z(r, "handleEvent", function(n) {
                                    return function(t) {
                                        return En("click", dn.bind(null, "dom"))(t),
                                        n.call(this, t)
                                    }
                                }),
                                "keypress" === t && z(r, "handleEvent", function(n) {
                                    return function(t) {
                                        return xn(dn.bind(null, "dom"))(t),
                                        n.call(this, t)
                                    }
                                })) : ("click" === t && En("click", dn.bind(null, "dom"), !0)(this),
                                "keypress" === t && xn(dn.bind(null, "dom"))(this)),
                                n.call(this, t, r, e)
                            }
                        }),
                        z(t, "removeEventListener", function(n) {
                            return function(t, r, e) {
                                var i = r;
                                try {
                ...
                !function() {
                    ...
                    z(n, "send", function(n) {
                        return function() {
                            ...
                            return dn("xhr", e({}, o)),
                            "onreadystatechange"in i && "function" == typeof i.onreadystatechange ? z(i, "onreadystatechange", function(n) {
                                return function() {
                                    for (var t = [], r = 0; r < arguments.length; r++)
                                        t[r] = arguments[r];
                                    return u(),
                    ...
                    if (!function() {
                        ...
                        if (r) {
                            ...
                            try {
                                ...
                                e.contentWindow && e.contentWindow.fetch && (t = un(e.contentWindow.fetch)),
            ...
            case "history":
                !function() {
                    ...
                    sn.onpopstate = function() {
                        for (var n = [], t = 0; t < arguments.length; t++)
                            n[t] = arguments[t];
                        var r = sn.location.href
                          , e = an;
                        if (an = r,
                        dn("history", {
                            from: e,
                    ...
                    ,
                    z(sn.history, "pushState", o),
                    z(sn.history, "replaceState", o)
                }();
                break;
            default:
                X.warn("unknown instrumentation type:", n)
            }
    }
    function ln(n) {
        n && "string" == typeof n.type && "function" == typeof n.callback && (fn[n.type] = fn[n.type] || [],
        fn[n.type].push(n.callback),
        vn(n.type))
    }
    function dn(n, t) {
        var r, e;
        if (n && fn[n])
            try {
                for (var o = i(fn[n] || []), u = o.next(); !u.done; u = o.next()) {
                    var c = u.value;
                    try {
                        c(t)
                    } catch (t) {
    ...
    function pn(n) {
        return void 0 === n && (n = []),
        "Request"in sn && x(n[0], Request) && n[0].method ? String(n[0].method).toUpperCase() : n[1] && n[1].method ? String(n[1].method).toUpperCase() : "GET"
    }
    function yn(n) {
        return void 0 === n && (n = []),
        "string" == typeof n[0] ? n[0] : "Request"in sn && x(n[0], Request) ? n[0].url : String(n[0])
    }
    var mn, bn, wn = 1e3, gn = 0;
    function En(n, t, r) {
        return void 0 === r && (r = !1),
        function(e) {
            mn = void 0,
    ...
    function xn(n) {
        return function(t) {
            ...
            var e = r && r.tagName;
            e && ("INPUT" === e || "TEXTAREA" === e || r.isContentEditable) && (mn || En("input", n)(t),
            clearTimeout(mn),
    ...
    var jn = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+))?@)([\w\.-]+)(?::(\d+))?\/(.+)/
      , kn = function() {
        function n(n) {
            "string" == typeof n ? this._(n) : this.O(n),
            this.T()
        }
      ...
      , Sn = function() {
        ...
        n.prototype.setTag = function(n, t) {
            var r;
            return this.M = e({}, this.M, ((r = {})[n] = nn(t),
            r)),
            this.q(),
            this
        }
        ...
        n.prototype.setExtra = function(n, t) {
            var r;
            return this.A = e({}, this.A, ((r = {})[n] = nn(t),
            r)),
            this.q(),
            this
        }
        ...
        n.prototype.addBreadcrumb = function(n, t) {
            ...
            return this.I = void 0 !== t && t >= 0 ? u(this.I, [nn(i)]).slice(-t) : u(this.I, [nn(i)]),
            this.q(),
            this
        }
        ,
      ...
      , Dn = function() {
        ...
        n.prototype.getIntegration = function(n) {
            ...
            try {
                ...
                return X.warn("Cannot retrieve integration " + n.id + " from the current Hub"),
                null
            }
        }
        ,
        ...
        n.prototype.V = function(n) {
            ...
            X.warn("Extension method " + n + " couldn't be found, doing nothing.")
        }
        ,
        n
    }();
    ...
    function In() {
        var n = Rn();
        return Cn(n) && !Mn(n).isOlderThan(Tn) || An(n, new Dn),
        j() ? function(n) {
            try {
                var t = (i = module,
                o = "domain",
                ...
                if (!r)
                    return Mn(n);
                if (!Cn(r) || Mn(r).isOlderThan(Tn)) {
                    var e = Mn(n).getStackTop();
                    An(r, new Dn(e.client,Sn.clone(e.scope)))
                }
                return Mn(r)
            } catch (t) {
                return Mn(n)
    ...
    var Ln = function() {
        ...
        n.prototype.getRequestHeaders = function(n, t) {
            ...
            return e.push("sentry_timestamp=" + M()),
    ...
    function Pn(n) {
        ...
        return function(n) {
            ...
            t[n.name] = n,
            function(n) {
                -1 === Hn.indexOf(n.name) && (n.setupOnce(On, In),
                Hn.push(n.name),
                X.log("Integration installed: " + n.name))
            }(n)
        }),
        t
    }
    var Fn, Wn = function() {
        function n(n, t) {
            ...
            this.tn = new n(t),
            this.rn = t,
            t.dsn && (this.en = new kn(t.dsn)),
            this.in() && (this.Z = Pn(this.rn))
        }
        return n.prototype.captureException = function(n, t, r) {
            var e = this
              , i = t && t.event_id;
            return this.nn = !0,
            this.on().eventFromException(n, t).then(function(n) {
                return e.un(n, t, r)
            }).then(function(n) {
                i = n && n.event_id,
                e.nn = !1
        ...
        n.prototype.captureMessage = function(n, t, r, e) {
            var i = this
              , o = r && r.event_id;
            return this.nn = !0,
            (m(n) ? this.on().eventFromMessage("" + n, t, r) : this.on().eventFromException(n, r)).then(function(n) {
                return i.un(n, r, e)
            }).then(function(n) {
                o = n && n.event_id,
                i.nn = !1
        ...
        n.prototype.flush = function(n) {
            var t = this;
            return this.cn(n).then(function(r) {
                return clearInterval(r.interval),
                t.on().getTransport().close(n).then(function(n) {
                    return r.ready && n
                })
            })
        }
        ...
        n.prototype.getIntegration = function(n) {
            try {
                ...
                return X.warn("Cannot retrieve integration " + n.id + " from the current Client"),
                null
            }
        }
        ,
        ...
        n.prototype.an = function(n, t, r) {
            ...
            f.message && (f.message = $(f.message, s));
            var h = f.exception && f.exception.values && f.exception.values[0];
            h && h.value && (h.value = $(h.value, s));
            var v = f.request;
            v && v.url && (v.url = $(v.url, s)),
            void 0 === f.event_id && (f.event_id = _()),
            this.sn(f.sdk);
            var l = rn.resolve(f);
            return t && (l = t.applyToEvent(f, r)),
            l
        }
        ,
        ...
        ,
        n.prototype.un = function(n, t, r) {
            var e = this
              , i = this.getOptions()
              , o = i.beforeSend
              , u = i.sampleRate;
            return this.in() ? "number" == typeof u && Math.random() > u ? rn.reject("This event has been sampled, will not send event.") : new rn(function(i, u) {
                e.an(n, r, t).then(function(n) {
                    if (null !== n) {
                        var r = n;
                        try {
                            if (t && t.data && !0 === t.data.__sentry__ || !o)
                                return e.on().sendEvent(r),
                                void i(r);
                            var c = o(n, t);
                            if (void 0 === c)
                                ...
                                if (null === (r = c))
                                    return X.log("`beforeSend` returned `null`, will not send event."),
                                    void i(null);
                                e.on().sendEvent(r),
                                i(r)
                            }
            ...
            ) : rn.reject("SDK not enabled, will not send event.")
        }
        ,
        n.prototype.fn = function(n, t, r) {
            var e = this;
            n.then(function(n) {
                null !== n ? (e.on().sendEvent(n),
        ...
        function n(n) {
            this.rn = n,
            this.rn.dsn || X.warn("No DSN provided, backend will not do anything."),
            this.hn = this.vn()
        }
        return n.prototype.vn = function() {
            return new Xn
        }
        ,
        ...
        n.prototype.sendEvent = function(n) {
            this.hn.sendEvent(n).then(null, function(n) {
                X.error("Error while sending event: " + n)
            })
        }
        ,
    ...
    var $n = function() {
      ...
      , Jn = function() {
        ...
        n.prototype.dn = function(n, t) {
            return this.pn(n, t) ? (X.warn("Event dropped due to being internal Sentry Error.\nEvent: " + T(n)),
            !0) : this.yn(n, t) ? (X.warn("Event dropped due to being matched by `ignoreErrors` option.\nEvent: " + T(n)),
            !0) : this.mn(n, t) ? (X.warn("Event dropped due to being matched by `blacklistUrls` option.\nEvent: " + T(n) + ".\nUrl: " + this.bn(n)),
            !0) : !this.wn(n, t) && (X.warn("Event dropped due to not being matched by `whitelistUrls` option.\nEvent: " + T(n) + ".\nUrl: " + this.bn(n)),
            !0)
        }
        ,
        ...
        n.prototype.yn = function(n, t) {
            return void 0 === t && (t = {}),
            !(!t.ignoreErrors || !t.ignoreErrors.length) && this.gn(n).some(function(n) {
        ...
        n.prototype.ln = function(n) {
            return void 0 === n && (n = {}),
            {
                ...
                ignoreErrors: u(this.rn.ignoreErrors || [], n.ignoreErrors || [], Gn),
        ...
        n.prototype.gn = function(n) {
            ...
            if (n.exception)
                try {
                    ...
                    return X.error("Cannot extract message for event " + T(n)),
                    []
                }
            return []
        }
        ,
        n.prototype.bn = function(n) {
            try {
                if (n.stacktrace) {
                ...
                return X.error("Cannot extract url for event " + T(n)),
                null
            }
        }
        ,
      ...
      , Vn = "?"
      , Kn = /^\s*at (?:(.*?) ?\()?((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|[-a-z]+:|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i
      , Qn = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension).*?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js))(?::(\d+))?(?::(\d+))?\s*$/i
      , Yn = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i
            ...
            if (t = function(n) {
                ...
                for (var t, r, e, i = [], o = n.stack.split("\n"), u = 0; u < o.length; ++u) {
                    if (r = Kn.exec(o[u])) {
                        ...
                        r[2] && 0 === r[2].indexOf("eval") && (t = nt.exec(r[2])) && (r[2] = t[1],
                        r[3] = t[2],
                        r[4] = t[3]),
                        e = {
                            url: r[2],
                        ...
                        if (!(r = Qn.exec(o[u])))
                            continue;
                        r[3] && r[3].indexOf(" > eval") > -1 && (t = Zn.exec(r[3])) ? (r[1] = r[1] || "eval",
                        r[3] = t[1],
                        r[4] = t[2],
    ...
    var ft = function() {
        function n(n) {
            this.options = n,
            this.S = new en(30),
            this.url = new Ln(this.options.dsn).getStoreEndpointWithUrlEncodedAuth()
        }
      ...
      , vt = function(t) {
        function e() {
            ...
            return n.En = new Date(Date.now()),
            n
        }
        return r(e, t),
        e.prototype.sendEvent = function(t) {
            var r = this;
            if (new Date(Date.now()) < this.En)
                return Promise.reject({
                    event: t,
                    reason: "Transport locked till " + this.En + " due to too many requests.",
                    status: 429
                });
            var e = {
                body: JSON.stringify(t),
                method: "POST",
                referrerPolicy: cn() ? "origin" : ""
            };
            return this.S.add(new rn(function(t, i) {
                ht.fetch(r.url, e).then(function(e) {
                    var o = n.Status.fromHttpCode(e.status);
                    if (o !== n.Status.Success) {
                        if (o === n.Status.RateLimit) {
                            var u = Date.now();
                            r.En = new Date(u + U(u, e.headers.get("Retry-After"))),
                            X.warn("Too many requests, backing off till: " + r.En)
                        }
                        i(e)
                    } else
                        t({
      ...
      , lt = function(t) {
        ...
        e.prototype.sendEvent = function(t) {
            var r = this;
            return new Date(Date.now()) < this.En ? Promise.reject({
                event: t,
                reason: "Transport locked till " + this.En + " due to too many requests.",
                status: 429
            }) : this.S.add(new rn(function(e, i) {
                    ...
                    if (4 === o.readyState) {
                        ...
                        if (t !== n.Status.Success) {
                            if (t === n.Status.RateLimit) {
                                var u = Date.now();
                                r.En = new Date(u + U(u, o.getResponseHeader("Retry-After"))),
                                X.warn("Too many requests, backing off till: " + r.En)
                            }
                            i(o)
                        } else
      ...
      , pt = function(t) {
        ...
        i.prototype.vn = function() {
            if (!this.rn.dsn)
                return t.prototype.vn.call(this);
            var n = e({}, this.rn.transportOptions, {
                dsn: this.rn.dsn
            });
            return this.rn.transport ? new this.rn.transport(n) : on() ? new vt(n) : new lt(n)
        }
        ,
        i.prototype.eventFromException = function(t, r) {
            var e = at(t, r && r.syntheticException || void 0, {
        ...
        i.prototype.eventFromMessage = function(t, r, e) {
            ...
            var i = st(t, e && e.syntheticException || void 0, {
                attachStacktrace: this.rn.attachStacktrace
            });
            return i.level = r,
      ...
      , yt = "sentry.javascript.browser"
      , mt = function(n) {
        function t(t) {
            return void 0 === t && (t = {}),
            n.call(this, pt, t) || this
        }
        return r(t, n),
                ...
                if (this.in()) {
                    ...
                    if (n.eventId)
                        if (r) {
                            ...
                            e.async = !0,
                            e.src = new Ln(r).getReportDialogEndpoint(n),
                            n.onLoad && (e.onload = n.onLoad),
                            (t.head || t.body).appendChild(e)
                        } else
                            X.error("Missing `Dsn` option in showReportDialog call");
                    else
                        X.error("Missing `eventId` option in showReportDialog call")
                } else
                    X.error("Trying to call showReportDialog with Sentry Client is disabled")
        }
        ,
        t
    }(Wn)
            ...
            try {
                ...
                qn(function(r) {
                    r.addEventProcessor(function(n) {
                        var r = e({}, n);
                        return t.mechanism && (R(r, void 0, void 0),
                        N(r, t.mechanism)),
                        r.extra = e({}, r.extra, {
                            arguments: nn(i, 3)
                        }),
    ...
    var Et = function() {
        ...
        return t.prototype.setupOnce = function() {
            ...
            this.rn.onerror && (X.log("Global Handler attached: onerror"),
            this.On()),
            this.rn.onunhandledrejection && (X.log("Global Handler attached: onunhandledrejection"),
            this.Tn())
        }
        ,
        t.prototype.On = function() {
            if (!this.Sn) {
                var n = this;
                this.jn = this.xn.onerror,
                this.xn.onerror = function(r, e, i, o, u) {
                    var c = In()
                      , a = c.getIntegration(t)
                      , s = u && !0 === u.__sentry_own_request__;
                    if (!a || wt() || s)
                        return !!n.jn && n.jn.apply(this, arguments);
                    var f = c.getClient()
                      , h = m(u) ? n.Dn(r, e, i, o) : n.Rn(at(u, void 0, {
                    ...
                    !!n.jn && n.jn.apply(this, arguments)
                }
                ,
                this.Sn = !0
            }
        ...
        t.prototype.Tn = function() {
            if (!this._n) {
                var r = this;
                this.kn = this.xn.onunhandledrejection,
                this.xn.onunhandledrejection = function(e) {
                    var i = e;
                    try {
                    ...
                    if (!u || wt() || c)
                        return !r.kn || r.kn.apply(this, arguments);
                    var a = o.getClient()
                      , s = m(i) ? r.Nn(i) : at(i, void 0, {
                        attachStacktrace: a && a.getOptions().attachStacktrace,
                        rejection: !0
                    });
                    return s.level = n.Severity.Error,
                    N(s, {
                        handled: !1,
                    ...
                    !r.kn || r.kn.apply(this, arguments)
                }
                ,
                this._n = !0
            }
        ...
        ,
        t.prototype.Dn = function(n, t, r, e) {
        ...
        ,
        t.prototype.Rn = function(n, t, r, e) {
            n.exception = n.exception || {},
            n.exception.values = n.exception.values || [],
            n.exception.values[0] = n.exception.values[0] || {},
      ...
      , xt = function() {
        ...
        return n.prototype.Cn = function(n) {
            return function() {
                for (var t = [], r = 0; r < arguments.length; r++)
                    t[r] = arguments[r];
                var e = t[0];
        ...
        n.prototype.An = function(n) {
            ...
            r && r.hasOwnProperty && r.hasOwnProperty("addEventListener") && (z(r, "addEventListener", function(t) {
                return function(r, e, i) {
                    try {
                        "function" == typeof e.handleEvent && (e.handleEvent = gt(e.handleEvent.bind(e), {
                            mechanism: {
                                data: {
            ...
            z(r, "removeEventListener", function(n) {
                return function(t, r, e) {
                    var i = r;
                    try {
                        i = i && (i.__sentry_wrapped__ || i)
        ...
        n.prototype.Un = function(n) {
            return function() {
                ...
                return ["onload", "onerror", "onprogress"].forEach(function(n) {
                    n in t && "function" == typeof t[n] && z(t, n, function(t) {
                        return gt(t, {
                            mechanism: {
                                data: {
                                    function: n,
                ...
                "onreadystatechange"in this && "function" == typeof this.onreadystatechange && z(this, "onreadystatechange", function(n) {
                    var t = {
                        mechanism: {
                            data: {
                    ...
                    return n.__sentry_original__ && (t.mechanism.data.handler = L(n.__sentry_original__)),
                    gt(n, t)
                }),
                n.apply(this, r)
            }
        ...
        n.prototype.setupOnce = function() {
            this.In = this.In;
            var n = S();
            z(n, "setTimeout", this.Cn.bind(this)),
            z(n, "setInterval", this.Cn.bind(this)),
            z(n, "requestAnimationFrame", this.Mn.bind(this)),
            "XMLHttpRequest"in n && z(XMLHttpRequest.prototype, "send", this.Un.bind(this)),
            ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"].forEach(this.An.bind(this))
        }
        ,
        n.id = "TryCatch",
        n
      ...
      , jt = function() {
        ...
        return t.prototype.qn = function(t) {
            ...
            if ("assert" === t.level) {
                if (!1 !== t.args[0])
                    return;
                r.message = "Assertion failed: " + (G(t.args.slice(1), " ") || "console.assert"),
                r.data.extra.arguments = nn(t.args.slice(1), 3)
            }
            In().addBreadcrumb(r, {
                input: t.args,
                level: t.level
        ...
        t.prototype.Hn = function(n) {
            if (n.endTimestamp) {
                ...
                n.xhr.__sentry_own_request__ && kt(n.args[0])
        }
        ,
    ...
    var St = "cause"
      ...
      , Ot = function() {
        ...
        n.prototype.Xn = function(n, t) {
            if (!(n.exception && n.exception.values && t && x(t.originalException, Error)))
                return n;
            var r = this.Bn(t.originalException, this.Wn);
            return n.exception.values = u(r, n.exception.values),
            n
        }
        ,
        n.prototype.Bn = function(n, t, r) {
            if (void 0 === r && (r = []),
            !x(n[t], Error) || r.length + 1 >= this.k)
                return r;
            var e = ot(tt(n[t]));
            return this.Bn(n[t], t, u([e], r))
        }
        ,
        n.id = "LinkedErrors",
        n
      ...
      , Dt = function() {
        ...
        return n.prototype.setupOnce = function() {
            On(function(t) {
                if (In().getIntegration(n)) {
                    if (!Tt.navigator || !Tt.location)
                        return t;
                    var r = t.request || {};
                    return r.url = r.url || Tt.location.href,
                    r.headers = r.headers || {},
                    r.headers["User-Agent"] = Tt.navigator.userAgent,
                    e({}, t, {
                        request: r
                    })
                }
      ...
      , Nt = [new Jn, new $n, new xt, new jt, new Et, new Ot, new Dt];
    var It = {}
      , Ct = S();
    Ct.Sentry && Ct.Sentry.Integrations && (It = Ct.Sentry.Integrations);
    var Mt = e({}, It, zn, Rt);
    return n.BrowserClient = mt,
    n.Hub = Dn,
    n.Integrations = Mt,
    n.SDK_NAME = yt,
    n.SDK_VERSION = "5.10.2",
    n.Scope = Sn,
    n.Transports = dt,
    ...
    ,
    n.addGlobalEventProcessor = On,
    n.captureEvent = function(n) {
        return Un("captureEvent", n)
    }
    ,
    ...
    n.close = function(n) {
        var t = In().getClient();
        return t ? t.close(n) : rn.reject(!1)
    }
    ,
    ...
    ,
    n.defaultIntegrations = Nt,
    n.flush = function(n) {
        var t = In().getClient();
        return t ? t.flush(n) : rn.reject(!1)
    }
    ,
    n.forceLoad = function() {}
    ,
    n.getCurrentHub = In,
    n.getHubFromCarrier = Mn,
    n.init = function(n) {
        if (void 0 === n && (n = {}),
        void 0 === n.defaultIntegrations && (n.defaultIntegrations = Nt),
        void 0 === n.release) {
            var t = S();
        ...
        !function(n, t) {
            !0 === t.debug && X.enable(),
            In().bindClient(new n(t))
        }(mt, n)
    }
    ,
    n.lastEventId = function() {
        return In().lastEventId()
    }
    ,
    n.onLoad = function(n) {
        n()
    ...
    n.showReportDialog = function(n) {
        void 0 === n && (n = {}),
        n.eventId || (n.eventId = In().lastEventId());
        var t = In().getClient();
